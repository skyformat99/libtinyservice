...
ServiceCaller *ServiceCaller::getInstance()
{
    static ServiceCaller s_caller;
    return &s_caller;
}

void ServiceCaller::rpcCall(std::string &_return, const std::string &jsonarg, const std::string &module)
{
    Document indom;
